...
این روش برای مواقعی کاربرد دارد که دقت بالایی نیاز داریم و تاخیر زمانی اهمیت کمتری دارد
در این روش TCP بسته هارا طبق ترتیب مشخص شده دوباره مرتب میکند و تضمین میکند همه بسته ها به همان شکلی که ارسال شده اند به مقصد میرسند.
اگر بسته ای اشتباهی باشد دوباره ارسال میشود.
این نوع ارتباط توسط پروتکل هایی نظیر HTTP , HTTPs ,FTM استفاده میشود.
