...
این روش برای مواقعی کاربرد دارد که دقت بالایی نیاز داریم و تاخیر زمانی اهمیت کمتری دارد. TCP بسته هارا طبق ترتیب مشخص شده دوباره مرتب میکند و تضمین میکند کمه بسته ها به همان شکلی که ارسال شده اند به مقصد میرسند.
واگر بسته ای اشتباهی باشد دوباره ارسال میشود.
